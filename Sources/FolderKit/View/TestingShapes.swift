...
//Mudança de angulo da pasta superior ok, vaid de 1 a -1
...
//    topFolderSizeDecrease, vai de 1 a 0.5
    public func path(in rect: CGRect) -> Path {
        ...
        downPath.addArc(center: CGPoint(x: rect.maxX - (cornerRadius * (1 - frontFolderTabSizeDecrease)) - (textWidth * (1 - frontFolderTabSizeDecrease*0.5)), y: rect.minY + tabCornerRadius * (1 - frontFolderTabSizeDecrease)), radius: tabCornerRadius * (1 - frontFolderTabSizeDecrease), startAngle: Angle(degrees: 225 + (45 * frontFolderTabSizeDecrease)), endAngle: Angle(degrees: 270), clockwise: false)
...
struct TestingShapes: View {
    ...
    var body: some View {
        ...
        FrontFolder(identityInsetProportion: frontFolderTabSizeDecrease)
            .fill(.pink)
